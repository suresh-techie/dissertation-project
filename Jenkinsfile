        ...
        stage('Build') {
            steps {
                script {
                    ...
                    bat '''curl -X POST http://127.0.0.1:5000/api/update_failures -H "Content-Type: application/json" -d '{"failure_data": {"failures": [{"category": "Build Failure", "count": 10, "testname": "Test A"}, {"category": "Test Error", "count": 5, "testname": "Test B"}, {"category": "Warning", "count": 3, "testname": "Test C"}, {"category": "Dependenc Issue", "count": 9}]}}''''
                }
            }
        }
    }
